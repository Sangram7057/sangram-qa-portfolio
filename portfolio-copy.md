...
Public GitHub portfolio with QA case studies, testing templates, and sample deliverables. Includes NDA-safe examples of test planning, regression coverage tracking, API validation checklists, and defect reporting structure.
